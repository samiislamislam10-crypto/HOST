...
[{color}]◎══════════════════════════════════════◎
[FFD700]◉ —͞⼕SAMIㅤ友! BOT [9400D3]➤ /spnff ◉
"""
    return result
...
[B][C][00FFFF]কি কেমন আছো গেমে কি করো
[B][C][00FFFF]লেখাপড়া করো তো পড়তে হবে
[B][C][00FFFF]নকল আর হবেনা

[B][C][FF00FF]═══════════════
[B][C][FFFF00]WLC TO SAMI TxT
[B][C][FF00FF]═══════════════"""
...
[{color1}]━━━━━━━━━━━━━━━━━━
[FFD700]◉ —͞⼕SAMIㅤ友! BOT [FF69B4]➤ /joke ◉
[{color1}]━━━━━━━━━━━━━━━━━━
"""
...
[{color}]◎━━━━━━━━━━━━━━━━━━━━━━━━━━━◎
[FFFFFF]{message}
[FFD700]◉ —͞⼕SAMIㅤ友! BOT [00FF7F]➤ /frt ◉
"""
...
[{color}]◎━━━━━━━━━━━━━━━━━━━━━━━━━━━◎
[FFFFFF]{message}
[FFD700]◉ —͞⼕SAMIㅤ友! BOT [FF69B4]➤ /grt ◉
"""
...
[FF0000]╠═════════════╣
[FFD700] ⚡ OWNER REAL NAME : [FFFFFF]—͞⼕SAMIㅤ友!
[FFD700] ✨ কেউ GUILD BOT [FF0000]কিনতে চাইলে message করবেন, [00FFFF] Telegram: @SAMI
[FF0000]╠═════════════╣
[FFD700] ✨ Developer —͟͞͞ </> —͞⼕SAMIㅤ友! ❄️  ⚡
[FFD700]╚═════════════╝"""
...
[00FF00]Use: /b [name]"""
 ...
 # ==============================================================
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "cr", "hi", "sb"):
                            ...
                            s1 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 01 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]START MATCH
[B][C][FFD700]   └─ [FFFFFF]/start
[B][C][FF007F]✿ 02 ┃ [00FF00]LEAVE SQUAD
[B][C][FFD700]   └─ [FFFFFF]/leave
[B][C][FF007F]✿ 03 ┃ [00FF00]3 PLAYER GROUP
[B][C][FFD700]   └─ [FFFFFF]/3
[B][C][FF007F]✿ 04 ┃ [00FF00]5 PLAYER GROUP
[B][C][FFD700]   └─ [FFFFFF]/5
[B][C][FF007F]✿ 05 ┃ [00FF00]6 PLAYER GROUP
[B][C][FFD700]   └─ [FFFFFF]/6
[B][C][FF007F]✿ 06 ┃ [00FF00]JOIN SQUAD
[B][C][FFD700]   └─ [FFFFFF]! [code]
[B][C][FF007F]✿ 07 ┃ [00FF00]GHOST JOIN
[B][C][FFD700]   └─ [FFFFFF]/ghost [code]
[B][C][FFD700]═══════════════"""
                            ...
                            s2 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 02 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]SELF EMOTE
[B][C][FFD700]   └─ [FFFFFF][number]
[B][C][FF007F]✿ 02 ┃ [00FF00]MAGIC EMOTE
[B][C][FFD700]   └─ [FFFFFF]aa[number] [tc]
[B][C][FF007F]✿ 03 ┃ [00FF00]ALL EMOTES MENU
[B][C][FFD700]   └─ [FFFFFF]/menu[number]
[B][C][FF007F]✿ 04 ┃ [00FF00]EMOTE HIJACK
[B][C][FFD700]   └─ [FFFFFF]/hjk
[B][C][FF007F]✿ 05 ┃ [00FF00]MAX EVO (SELF)
[B][C][FFD700]   └─ [FFFFFF]max
[B][C][FF007F]✿ 06 ┃ [00FF00]STOP EVO CYCLE
[B][C][FFD700]   └─ [FFFFFF]/s
[B][C][FF007F]✿ 07 ┃ [00FF00]MAX EVO (BOT)
[B][C][FFD700]   └─ [FFFFFF]@max
[B][C][FFD700]═══════════════"""
                            ...
                            s3 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 03 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]STOP BOT EVO
[B][C][FFD700]   └─ [FFFFFF]/o
[B][C][FF007F]✿ 02 ┃ [00FF00]RANDOM EVO (SELF)
[B][C][FFD700]   └─ [FFFFFF]new
[B][C][FF007F]✿ 03 ┃ [00FF00]STOP RANDOM
[B][C][FFD700]   └─ [FFFFFF]/sm
[B][C][FF007F]✿ 04 ┃ [00FF00]RANDOM (BOT)
[B][C][FFD700]   └─ [FFFFFF]@new
[B][C][FF007F]✿ 05 ┃ [00FF00]ONLY BOT RANDOM
[B][C][FFD700]   └─ [FFFFFF]@bot
[B][C][FF007F]✿ 06 ┃ [00FF00]STOP BOT CYCLE
[B][C][FFD700]   └─ [FFFFFF]@bt
[B][C][FF007F]✿ 07 ┃ [00FF00]FAST EMOTE SPAM
[B][C][FFD700]   └─ [FFFFFF]/fast [uid] [emote]
[B][C][FFD700]═══════════════"""
                            ...
                            s4 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 04 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]CUSTOM SPAM
[B][C][FFD700]   └─ [FFFFFF]/p [uid] [emote] [num]
[B][C][FF007F]✿ 02 ┃ [00FF00]REJECT SPAM
[B][C][FFD700]   └─ [FFFFFF]/reject [uid]
[B][C][FF007F]✿ 03 ┃ [00FF00]STOP REJECT
[B][C][FFD700]   └─ [FFFFFF]/reject_stop
[B][C][FF007F]✿ 04 ┃ [00FF00]MESSAGE SPAM
[B][C][FFD700]   └─ [FFFFFF]/msg [text] [times]
[B][C][FF007F]✿ 05 ┃ [00FF00]STOP MSG SPAM
[B][C][FFD700]   └─ [FFFFFF]/stop msg
[B][C][FF007F]✿ 06 ┃ [00FF00]WAVE MSG SPAM
[B][C][FFD700]   └─ [FFFFFF]/mg [text] [repeats]
[B][C][FF007F]✿ 07 ┃ [00FF00]BAN CHECK
[B][C][FFD700]   └─ [FFFFFF]/check [uid]
[B][C][FFD700]═══════════════"""
                            ...
                            s5 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 05 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]BADGE SPAM 1
[B][C][FFD700]   └─ [FFFFFF]/s1 [uid]
[B][C][FF007F]✿ 02 ┃ [00FF00]BADGE SPAM 2
[B][C][FFD700]   └─ [FFFFFF]/s2 [uid]
[B][C][FF007F]✿ 03 ┃ [00FF00]BADGE SPAM 3
[B][C][FFD700]   └─ [FFFFFF]/s3 [uid]
[B][C][FF007F]✿ 04 ┃ [00FF00]BADGE SPAM 4
[B][C][FFD700]   └─ [FFFFFF]/s4 [uid]
[B][C][FF007F]✿ 05 ┃ [00FF00]BADGE SPAM 5
[B][C][FFD700]   └─ [FFFFFF]/s5 [uid]
[B][C][FF007F]✿ 06 ┃ [00FF00]INVITE PLAYER
[B][C][FFD700]   └─ [FFFFFF]/inv [uid]
[B][C][FF007F]✿ 07 ┃ [00FF00]JOIN CUSTOM ROOM
[B][C][FFD700]   └─ [FFFFFF]/joinroom [id] [pass]
[B][C][FFD700]═══════════════"""        
                            ...
                            s6 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 06 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]STOP LAG ATTACK
[B][C][FFD700]   └─ [FFFFFF]/stop lag
[B][C][FF007F]✿ 02 ┃ [00FF00]PLAYER INFO
[B][C][FFD700]   └─ [FFFFFF]/info [uid]
[B][C][FF007F]✿ 03 ┃ [00FF00]PLAYER STATUS
[B][C][FFD700]   └─ [FFFFFF]/status [uid]
[B][C][FF007F]✿ 04 ┃ [00FF00]BOY GALI SPAM
[B][C][FFD700]   └─ [FFFFFF]/gali [name]
[B][C][FF007F]✿ 05 ┃ [00FF00]GIRL GALI SPAM
[B][C][FFD700]   └─ [FFFFFF]/galli [name]
[B][C][FF007F]✿ 06 ┃ [00FF00]PRAISE SOMEONE
[B][C][FFD700]   └─ [FFFFFF]/praisa [name]
[B][C][FFD700]═══════════════"""
                            ...
                            s7 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 07 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]CHAT WITH AI
[B][C][FFD700]   └─ [FFFFFF]/ai [question]
[B][C][FF007F]✿ 02 ┃ [00FF00]SHOW HELP
[B][C][FFD700]   └─ [FFFFFF]/help
[B][C][FF007F]✿ 03 ┃ [00FF00]ADMIN INFO
[B][C][FFD700]   └─ [FFFFFF]/admin
[B][C][FF007F]✿ 04 ┃ [00FF00]ATTACK ROOM
[B][C][FFD700]   └─ [FFFFFF]/room [uid] [room_id]
[B][C][FF007F]✿ 05 ┃ [00FF00]GUILD INFO
[B][C][FFD700]   └─ [FFFFFF]/clan [id]
[B][C][FF007F]✿ 06 ┃ [00FF00]EQUIP BUNDLE
[B][C][FFD700]   └─ [FFFFFF]/b [number]
[B][C][FF007F]✿ 07 ┃ [00FF00]LOVE LETTER
[B][C][FFD700]   └─ [FFFFFF]/later [name]
[B][C][FFD700]═══════════════"""
                            ...
                            s8 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 08 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]SAD LETTER
[B][C][FFD700]   └─ [FFFFFF]/sadlater [name]
[B][C][FF007F]✿ 02 ┃ [00FF00]LOVE SPAM
[B][C][FFD700]   └─ [FFFFFF]/love [name]
[B][C][FF007F]✿ 03 ┃ [00FF00]ROAST SOMEONE
[B][C][FFD700]   └─ [FFFFFF]/rt [name]
[B][C][FF007F]✿ 04 ┃ [00FF00]ADD 1000 VISIT
[B][C][FFD700]   └─ [FFFFFF]/visit [uid]
[B][C][FF007F]✿ 05 ┃ [00FF00]ADD FRIEND
[B][C][FFD700]   └─ [FFFFFF]/add [uid]
[B][C][FF007F]✿ 06 ┃ [00FF00]REMOVE FRIEND
[B][C][FFD700]   └─ [FFFFFF]/remove [uid]
[B][C][FF007F]✿ 07 ┃ [00FF00]DM USER
[B][C][FFD700]   └─ [FFFFFF]/dm [uid]
[B][C][FFD700]═══════════════"""
                            ...
                            s9 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 09 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]LAG ATTACK
[B][C][FFD700]   └─ [FFFFFF]/attack
[B][C][FF007F]✿ 02 ┃ [00FF00]SPAM INVITE
[B][C][FFD700]   └─ [FFFFFF]/spm_inv [uid]
[B][C][FF007F]✿ 03 ┃ [00FF00]FRIEND REQ SPAM
[B][C][FFD700]   └─ [FFFFFF]/spam_req [uid]
[B][C][FF007F]✿ 04 ┃ [00FF00]ANIMATION
[B][C][FFD700]   └─ [FFFFFF]/animation [number]
[B][C][FF007F]✿ 05 ┃ [00FF00]EMOTE SEND
[B][C][FFD700]   └─ [FFFFFF]/e [emote]
[B][C][FF007F]✿ 06 ┃ [00FF00]5v5 UNLOCK
[B][C][FFD700]   └─ [FFFFFF]/snd [uid]
[B][C][FF007F]✿ 07 ┃ [00FF00]FRIEND %
[B][C][FFD700]   └─ [FFFFFF]/frt [n1]&[n2]
[B][C][FFD700]═══════════════"""
                            ...
                            s10 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 10 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]SOUL %
[B][C][FFD700]   └─ [FFFFFF]/grt [n1]&[n2]
[B][C][FF007F]✿ 02 ┃ [00FF00]QUIZ
[B][C][FFD700]   └─ [FFFFFF]/quiz
[B][C][FF007F]✿ 03 ┃ [00FF00]DARE
[B][C][FFD700]   └─ [FFFFFF]/dare
[B][C][FF007F]✿ 04 ┃ [00FF00]TRUTH
[B][C][FFD700]   └─ [FFFFFF]/truth
[B][C][FF007F]✿ 05 ┃ [00FF00]DICE ROLL
[B][C][FFD700]   └─ [FFFFFF]/roll
[B][C][FF007F]✿ 06 ┃ [00FF00]ZODIAC
[B][C][FFD700]   └─ [FFFFFF]/zodiac
[B][C][FF007F]✿ 07 ┃ [00FF00]JOKE
[B][C][FFD700]   └─ [FFFFFF]/joke
[B][C][FFD700]═══════════════"""
                            ...
                            s11 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 11 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]SPIN BUNDLE
[B][C][FFD700]   └─ [FFFFFF]/spnff
[B][C][FF007F]✿ 02 ┃ [00FF00]WEATHER
[B][C][FFD700]   └─ [FFFFFF]/weather
[B][C][FF007F]✿ 03 ┃ [00FF00]TITLE
[B][C][FFD700]   └─ [FFFFFF]/title [uid]
[B][C][FF007F]✿ 04 ┃ [00FF00]FORTUNE
[B][C][FFD700]   └─ [FFFFFF]/luck [name]
[B][C][FF007F]✿ 05 ┃ [00FF00]GUILD JOIN
[B][C][FFD700]   └─ [FFFFFF]/guild_join [guild_id]
[B][C][FF007F]✿ 06 ┃ [00FF00]GUILD LEAVE
[B][C][FFD700]   └─ [FFFFFF]/guild_leave [guild_id]
[B][C][FF007F]✿ 07 ┃ [00FF00]BOT ON
[B][C][FFD700]   └─ [FFFFFF]/on
[B][C][FFD700]═══════════════"""
                            ...
                            s12 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI MENU 12 ✿
[B][C][FFD700]═══════════════
[B][C][FF007F]✿ 01 ┃ [00FF00]BOT OFF
[B][C][FFD700]   └─ [FFFFFF]/off
[B][C][FF007F]✿ 02 ┃ [00FF00]DM USER
[B][C][FFD700]   └─ [FFFFFF]/dm [uid]
[B][C][FF007F]✿ 03 ┃ [00FF00]LAG ATTACK
[B][C][FFD700]   └─ [FFFFFF]/attack
[B][C][FF007F]✿ 04 ┃ [00FF00]ROOM SPAM
[B][C][FFD700]   └─ [FFFFFF]/spamapi [uid]
[B][C][FF007F]✿ 05 ┃ [00FF00]FRIEND REQ SPAM
[B][C][FFD700]   └─ [FFFFFF]/spam_req [uid]
[B][C][FF007F]✿ 06 ┃ [00FF00]ANIMATION
[B][C][FFD700]   └─ [FFFFFF]/animation [name]
[B][C][FF007F]✿ 07 ┃ [00FF00]STOP ROOM SPAM
[B][C][FFD700]   └─ [FFFFFF]/stopapi [uid]
[B][C][FFD700]═══════════════"""
                            ...
                            s15 = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ R A F I N ✿
[B][C][FFD700]═══════════════

[B][C][FF007F]✿ [00FF00]TELEGRAM [B][C][FFFFFF]@MAX_6T9_666
...
[B][C][FFD700]═══════════════"""
                            ...
                            guild = """
[B][C][FFD700]═══════════════
[B][C][00FFCC]✿ SAMI TxT BOT ✿
[B][C][FFD700]═══════════════

[B][C][FF007F]✿ [00FF00]এই TCP BOT-টি বানিয়েছে
[B][C][FFFFFF]SAMI TxT BOT

[B][C][FF007F]✿ [00FF00]এবং আরও তিনজন
[B][C][FFFFFF]এতে কাজ করেছে।

[B][C][FF007F]✿ [00FF00]পাকিস্তানের একটি
[B][C][FFFFFF]মেয়ে এবং তিনজন ছেলে।

[B][C][FFD700]═══════════════
[B][C][00FFCC]TIK TOK: SAMItxt_370x
[B][C][FFD700]═══════════════
"""
